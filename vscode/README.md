...
*Note: While I am not directly affiliated with the original OsmiumToolchains team, this updated version is published under their name with their permission.*
...
The extension can be downloaded from the VS Code Marketplace by searching for **"Osmium solidity"** or using the ID `osmiumtoolchains.osmium-solidity-extension`.
